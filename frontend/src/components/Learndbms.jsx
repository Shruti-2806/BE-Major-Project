...
export const Learndbms = () => {
  ...
  return (
    <div className="flex flex-col h-screen p-8 bg-gray-100 text-gray-900">
      <Link to="/learndbmslist" className="mb-4 inline-block">
      ...
      <div className="flex-grow flex items-center justify-center">
        {subtopic ? (
          <div className="bg-white p-8 rounded-lg shadow-lg w-full h-full overflow-auto">
            ...
            <button className="mt-4 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded transition">
              Practice
            </button>
          </div>
        ) : (
